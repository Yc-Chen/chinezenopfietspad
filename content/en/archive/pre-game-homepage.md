---
title: "Pre-game homepage (archived)"
linkTitle: "Pre-game homepage"
_build:
  render: always
  list: never
...
> This is the original marketing-style homepage, kept for reference after the site switched to the ganzenbord format. See `PLAN.md`. Content below may migrate into `data/tiles/v1.yaml` tile by tile.

{{< blocks/cover title="Chinese op Fietspad: A Retaliate" image_anchor="top" height="full" >}}
<a class="btn btn-lg btn-primary me-3 mb-4" href="/about/">
  Why / 动机 <i class="fas fa-arrow-alt-circle-right ms-2"></i>
</a>
<a class="btn btn-lg btn-secondary me-3 mb-4" href="https://github.com/Yc-Chen/chineseopfietspad">
  Contribute / 加料 <i class="fab fa-github ms-2 "></i>
</a>
<p class="lead mt-5">关于荷兰和荷兰人的槽点合集</p>
...
<!-- {{% blocks/feature icon="fa fa-wine-bottle" title="1 - Plastic bottle caps are attached" %}}
Thanks to the EU regulations, plastic bottle caps are attached to the bottles, so that you cannot throw them away separately.
{{% /blocks/feature %}} -->
...
{{% blocks/feature icon="fa fa-truck" title="J - Nobody rings the doorbell but you miss the package anyways" %}}
TODO
{{% /blocks/feature %}}
...
<!-- {{% blocks/feature icon="fa fa-bowl-food" title="A - Nasi and bami are not Chinese."%}}
